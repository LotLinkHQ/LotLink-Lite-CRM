...
const s = StyleSheet.create({
  ...
  memberRow: { backgroundColor: C.surfaceLit, borderRadius: 8, padding: 12, flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  ...
  textInput: {
    backgroundColor: C.surfaceLit, borderWidth: 1, borderColor: C.rule,
